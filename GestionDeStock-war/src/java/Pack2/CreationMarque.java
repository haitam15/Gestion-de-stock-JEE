...
public class CreationMarque extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form action=\"CreationMarque\" class=\"forme\" method=\"POST\">");
            out.println("<span class=\"label\">Nom de la marque :</span>");
            out.println("<input type=\"text\" name=\"nomMarque\"/>");
            out.println("</br>");
            out.println("<span class=\"label\">");
            out.println("Origine de fabrication :");
            out.println("</span>");
            out.println("<input type=\"text\" name=\"origineDeFabrication\"/>");
            out.println("</br>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean created = marqueFacade.creer(nomMarque, origineDeFabrication);
            /* TODO output your page here. You may use following sample code. */
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 class=\"gradient-box \">Servlet CreationMarque at</h1>");
            out.println("<div class=\"container \">");
            if (created) {
                out.println("<h2 class=\"animate__animated animate__backInDown\">La marque est cree avec succes ✔</h2>");
                
            } else {
                out.println("<h2 class=\"not animate__animated animate__backInDown\">Probleme de création de marque ❌</h2>");
            }
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
