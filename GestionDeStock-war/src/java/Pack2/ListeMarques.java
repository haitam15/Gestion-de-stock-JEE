...
public class ListeMarques extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<thead>");
            out.println("<tr>");
            out.println("<th>Nom de la marque</th>");
            out.println("<th>Origine de fabrication</th>");
            ...
            for(Marque marque : listeMarques) {
                out.println("<tr>");
                out.println("<td>" + marque.getNomMarque() + "</td>");
                out.println("<td>" + marque.getOrigineDeFabrication() + "</td>");
                out.println("<td>");
                    out.println("<form action=\"ModificationMarque\" method=\"GET\">");
                    ...
                    out.println("</form>");
                    out.println("<form action=\"ListeMarques\" method=\"POST\">");
                    out.println("<input name=\"nomMarque\" value=\"" + marque.getNomMarque() + "\" hidden/>");
                    out.println("<input class=\"dell\" type=\"submit\" value=\"supprimer\"/>");
                    out.println("</form>");
                out.println("</td>");
                out.println("</tr>");
            }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean deleted = marqueFacade.supprimer(marque);
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 class=\"gradient-box \">Servlet SuppressionMarque at</h1>");
            out.println("<div class=\"container \">");
            if (deleted) {
                out.println("<h2 class=\"animate__animated animate__backInDown\">La marque est supprimée avec succes ✔</h2>");
                
            } else {
                out.println("<h2 class=\"not animate__animated animate__backInDown\">Probleme de suppression de marque ❌</h2>");
            }
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
