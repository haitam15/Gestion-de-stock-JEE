...
public class CreationProduit extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form action=\"CreationProduit\" class=\"forme\" method=\"POST\">");
            ...
            out.println("<input type=\"text\" name=\"denomination\"/>");
            out.println("</br>");
            out.println("<span class=\"label\">Prix :</span>");
            out.println("<input type=\"text\" name=\"prix\"/>");
            out.println("</br>");
            out.println("<span class=\"label\">Poids :</span>");
            out.println("<input type=\"text\" name=\"poids\"/>");
            out.println("</br>");
            out.println("<span class=\"label\">Volume :</span>");
            out.println("<input type=\"text\" name=\"volume\"/>");
            out.println("</br>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(marqueProduit!=null)
                created = produitFacade.creer(referenceProduit, marqueProduit, denomination, prix, poids, volume);
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 class=\"gradient-box \">Servlet CreationProduit at</h1>");
            out.println("<div class=\"container \">");
            if (created) {
                out.println("<h2 class=\"animate__animated animate__backInDown\">Le produit est cree avec succes ✔</h2>");
                Produit produit = new Produit(referenceProduit, marqueProduit, denomination, prix, poids, volume);
                marqueFacade.ajouterProduitMarque(marqueProduit, produit);
                
            } else {
                out.println("<h2 class=\"not animate__animated animate__backInDown\">Probleme de création de produit ❌</h2>");
            }
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
