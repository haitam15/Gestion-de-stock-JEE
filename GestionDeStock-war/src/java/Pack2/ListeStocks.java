 ...
 * @author haitam
 */
public class ListeStocks extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListeStocks</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListeStocks at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Stock> listeStocks = stockFacade.listeStocks();
            ...
            out.println("");
            out.println("<body>");
            out.println("<h1 class=\"gradient-box\">Servlet Liste Stock</h1>");
            out.println("<section>");
            out.println("<table class=\"rwd-table animate__animated animate__backInUp \">");
            out.println("<tr>");
            out.println("<th>Nom de Stock</th>");
            out.println("<th class=\"hed\">Action</th>");
            out.println("</tr>");
            for(Stock stock : listeStocks) {
                out.println("<tr>");
                out.println("<td>" + stock.getNomStock() + "</td>");
                out.println("<td class=\"action\">");
                out.println("<form action=\"AjouterProduit\" method=\"GET\">");
                out.println("<input type=\"text\" name=\"nomStock\" value=\"" + stock.getNomStock() + "\" hidden/>");
                out.println("<input class=\"modifier\" type=\"submit\" value=\"Ajouter Produits\" />");
                out.println("</form>");
                out.println("");
                out.println("<form action=\"ListeProduitsStock\" method=\"GET\">");
                out.println("<input type=\"text\" name=\"nomStock\" value=\"" + stock.getNomStock() + "\" hidden/>");
                out.println("<input class=\"del\" type=\"submit\" value=\"List Produits\" />");
                out.println("</form>");
                out.println("</td>");
                out.println("</tr>");
            }
