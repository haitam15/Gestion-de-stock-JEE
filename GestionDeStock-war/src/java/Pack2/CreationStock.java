...
public class CreationStock extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("text-align:center;");
            out.println("background-color : #6b4ba199;");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 class=\"gradient-box\">Servlet Creation Stock</h1>");
            out.println("<div class=\"form animate__animated animate__backInUp\">");
            out.println("<form action=\"CreationStock\" class=\"forme\" method=\"POST\">");
            out.println("<span class=\"label\">Nom de  Stock :</span>");
            out.println("<input type=\"text\" name=\"nomStock\"/>");
            out.println("</br>");
            out.println("<input type=\"submit\" value=\"Créer Stock\"/>");
            out.println("</form>");
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean created = stockFacade.creer(nomStock);
            /* TODO output your page here. You may use following sample code. */
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 class=\"gradient-box \">Servlet CreationStock at</h1>");
            out.println("<div class=\"container \">");
            if (created) {
                out.println("<h2 class=\"animate__animated animate__backInDown\">Le stock est cree avec succes ✔</h2>");
                
            } else {
                out.println("<h2 class=\"not animate__animated animate__backInDown\">Probleme de création de stock ❌</h2>");
            }
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
