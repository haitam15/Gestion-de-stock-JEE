 ...
 * @author haitam
 */
public class ModifierQuantite extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ModifierQuantite</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ModifierQuantite at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Modifier Quantite</title>");
            out.println("<style>");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 class=\"gradient-box\">Servlet Modifier Quantite</h1>");
            out.println("<div class=\"form animate__animated animate__backInUp\">");
            out.println("<form action=\"ModifierQuantite\" class=\"forme\" method=\"POST\">");
            out.println("<input name=\"nomStock\" value=\"" + nomStock + "\" hidden/>");
            out.println("<input name=\"referenceProduit\" value=\"" + referenceProduit + "\" hidden/>");
            ...
            out.println("<span>" + referenceProduit + "</span>");
            out.println("</br>");
            out.println("<span class=\"label\">");
            out.println("Quantite :");
            out.println("</span>");
            out.println("<input type=\"text\" name=\"quantite\" value=\"" + quantite + "\"/>");
            out.println("</br>");
            out.println("<input type=\"submit\" value=\"Modifier quantite\"/>");
            out.println("</form>");
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(refProduit!=null)
                modified = stockFacade.modifierQuantite(nomStock, refProduit, quantite);
            /* TODO output your page here. You may use following sample code. */
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 class=\"gradient-box \">Servlet ModifierQuantite at</h1>");
            out.println("<div class=\"container \">");
            if (modified) {
                out.println("<h2 class=\"animate__animated animate__backInDown\">La quantité est modifié avec succes ✔</h2>");
                
            } else {
                out.println("<h2 class=\"not animate__animated animate__backInDown\">Probleme de modification de quantité ❌</h2>");
            }
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
